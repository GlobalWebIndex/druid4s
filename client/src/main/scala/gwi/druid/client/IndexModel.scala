...
case class ArbitraryGranularitySpec(`type`: String, intervals: List[String], rollup: Boolean = true, queryGranularity: Option[String] = Option.empty)
    extends GranularitySpec
case class UniformGranularitySpec(
    `type`: String,
...
case class GranularityInputSpec(`type`: String, dataGranularity: String, inputPath: String, filePattern: String, pathFormat: Option[String] = Option.empty)
    extends InputSpec
